      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center">
          <h1 className="text-4xl font-bold text-gray-900 dark:text-white sm:text-5xl md:text-6xl">
            Welcome to{" "}
            <span className="text-blue-600 dark:text-blue-400">Word Flow</span>
          </h1>
          <p className="mt-3 max-w-md mx-auto text-base text-gray-500 dark:text-gray-400 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
            Master English vocabulary through intelligent text analysis and
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
            <div className="text-center">
              ...
              <p className="mt-2 text-base text-gray-500 dark:text-gray-400">
                Upload text files or paste content to analyze vocabulary and
            ...
            <div className="text-center">
              ...
              <p className="mt-2 text-base text-gray-500 dark:text-gray-400">
                Build your vocabulary with personalized word lists and
                definitions.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="mt-2 text-base text-gray-500 dark:text-gray-400">
                Practice with interactive training sessions tailored to your
                learning progress.
              </p>
            </div>
          </div>
